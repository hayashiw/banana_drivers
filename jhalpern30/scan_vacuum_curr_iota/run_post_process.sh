...
#SBATCH --job-name=post_process_scan_vacuum_curr_iota
...
# dirs in $SCRATCH/.../scan_vacuum_curr_iota/.
#
...
SCAN_ROOT="${SCRATCH_BASE}/banana_drivers_outputs/scan_vacuum_curr_iota"
